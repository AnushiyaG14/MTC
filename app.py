    ...
    def store_document(self, document_data: Dict) -> str:
        ...
        try:
            ...
            cursor.execute(insert_query, (
                ...
                document_data.get('certificate_number'),
                document_data.get('heat_number'),
                document_data.get('material_grade'),
                document_data.get('specification'),
                document_data.get('manufacturer'),
                document_data.get('customer_name'),
                document_data.get('order_number'),
                document_data.get('cast_number'),
                document_data.get('lot_number'),
                document_data.get('product_form'),
                document_data.get('dimensions'),
                document_data.get('thickness'),
                document_data.get('width'),
                document_data.get('length'),
                document_data.get('diameter'),
                document_data.get('weight'),
                document_data.get('quantity'),
                document_data.get('manufacturing_date'),
                document_data.get('test_date'),
                document_data.get('certificate_date'),
                safe_json_dumps(document_data.get('chemical_composition')),
                safe_json_dumps(document_data.get('mechanical_properties')),
                safe_json_dumps(document_data.get('heat_treatment')),
                document_data.get('test_temperature'),
                document_data.get('test_standard'),
                document_data.get('sampling_location'),
                document_data.get('test_direction'),
                document_data.get('certified_by'),
                document_data.get('inspector_name'),
                document_data.get('approval_signature'),
                document_data.get('remarks'),
                safe_json_dumps(document_data.get('compliance_standards', [])),
                document_data.get('confidence_score'),
                document_data.get('file_type'),
                document_data.get('extracted_text_length'),
                safe_json_dumps(document_data)
            ))
